(async function () {
    ...
    let shpae_color = await ShanhaiBI.getSetting("shape-color");
    ...
    let animation_delay_time = await ShanhaiBI.getSetting("animation-delay-time");
    ...
    function makeOption(type, symbol) {
        return {
            ...
            animationDurationUpdate: animation_update_time * 1000,
            series: [
                {
                    name: '2015',
                    id: 'bar1',
                    ...
                    universalTransition: {
                        ...
                        delay: function (idx, total) {
                            return (idx / total) * animation_duration * 1000;
                        }
                    },
                    data: [
                        {
    ...
    let optionIndex = 0;
    let setTime = (animation_duration + animation_delay_time + animation_update_time) * 1000;
