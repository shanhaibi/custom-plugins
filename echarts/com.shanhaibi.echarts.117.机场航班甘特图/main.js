            ...
            series: [
                {
                    id: 'flightData',
                    type: 'custom',
                    color: shape_color[2] ? shape_color[2] : "#1890ff",
        ...
        return {
            ...
            children: [
                ...
                },
                {
                    ...
                    shape: rectVIP,
                    style: api.style({ fill: shape_color[1] ? shape_color[1] : "#d9b105" })
                },
                {
                    type: 'rect',
                    ignore: !rectText,
            ...
            children: [
                {
                    ...
                    style: {
                        fill: shape_color[0] ? shape_color[0] : "#468c6c"
                    }
                },
                {
                    type: 'text',
