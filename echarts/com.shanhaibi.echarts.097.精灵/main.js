(async function () {
    ...
    let maxData = await ShanhaiBI.getSetting("max-scale");
    let animation_update_time = await ShanhaiBI.getSetting("animation-update-time");
