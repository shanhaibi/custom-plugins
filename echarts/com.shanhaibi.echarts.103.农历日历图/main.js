(async function () {
    ...
    let month_arr = ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月",];
    let month_idx = await ShanhaiBI.getSetting("month");
    let dateList = [
        ['2017-1-1', '初四'],
        ['2017-1-2', '初五'],
        ['2017-1-3', '初六'],
    ...
    let option = {
        title: {
            text: month_arr[month_idx],
            left: "center",
            textStyle: {
                color: await ShanhaiBI.getSetting("month-label-color"),
                fontSize: await ShanhaiBI.getSetting("month-label-size")
            }
        },
        tooltip: {
        ...
        calendar: [
            {
                ...
                range: '2017-' + (parseInt(month_idx) + 1)
            }
        ],
        series: [
            {
